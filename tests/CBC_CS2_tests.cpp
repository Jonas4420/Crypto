	...
	for ( auto file : files ) {
		...
		for ( auto tests : test_vectors ) {
			for ( auto test : tests ) {
				...
				Crypto::CBC_CS2<Crypto::AES> ctx(key, key_sz, iv, true);
...
TEST(CBC_CS2, steal_test_vector_enc)
{
	...
	for ( auto file : files ) {
		...
		for ( auto tests : test_vectors ) {
			for ( auto test : tests ) {
				...
				Crypto::CBC_CS2<Crypto::AES> ctx(key, key_sz, iv, false);
...
TEST(CBC_CS2, steal_test_vector_dec)
{
	const std::vector<std::vector<std::string>> tests = {
		{
			"000102030405060708090a0b0c0d0e0f", "101112131415161718191a1b1c1d1e1f",
